...
public class Assignment2POM 
{
	...
	static void createUser()
	{
		try
		{
			...
			oPage.getCreateuserFirstname().sendKeys("Arati");
			oPage.getCreateUserLastName().sendKeys("Jain");
			Thread.sleep(2000);
			oPage.getCreateUserEmail().sendKeys("aratijain05@gmail.com");
			oPage.getCreateUsername().sendKeys("Arati");
